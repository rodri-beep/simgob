...
The pixel fonts bundled here are used **only for chrome/titles**; all numbers
and data text use a clean system sans for legibility.

- **Press Start 2P** — Copyright © The Press Start 2P Project Authors
  (cody@zone38.net). SIL Open Font License 1.1.
- **Silkscreen** — Copyright © Jason Kottke. SIL Open Font License 1.1.

Both fonts are licensed under the **SIL Open Font License, Version 1.1**.
Full text: https://openfontlicense.org/ — summary below.
